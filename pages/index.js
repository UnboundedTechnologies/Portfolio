    ...
    <Container>
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          ...
          <Paragraph>
            • Video Games (8th League of Legends French Cup - {' '}<Link href="https://liquipedia.net/leagueoflegends/LFL/2022/Coupe_de_France/Qualifier/2" target="_blank" _hover={{ textDecoration: "none" }}>
            Team Look For Win
          </Link>
            )
            <br />
          ...
          <Paragraph>
            • Judo/Jujitsu - {' '}<Link href="http://www.ffjudo.org/extranet/listehautgrades/liste_hauts_grades_dep.asp?Page=1&dis=0&grade=1&ndep=XX1177" target="_blank" _hover={{ textDecoration: "none" }}>
